...
function OrbitItemNode({ item, index, totalItems, path, itemSize, rotation, progress, fill }: OrbitItemProps) {
  ...
  return (
    ...
    >
      <div style={{ transform: `rotate(${-rotation}deg)`, width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>{item}</div>
    </motion.div>
  );
}
