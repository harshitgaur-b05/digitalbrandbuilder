...
export default function FinalCTA() {
  return (
    <section className="bg-brand-bg py-24 md:py-32 relative overflow-hidden" id="cta">
      <div className="absolute pointer-events-none z-0 opacity-40 top-[-20%] left-[-10%] w-[50vw] h-[50vw] rounded-[45%_55%_35%_65%/_55%_45%_65%_35%] bg-brand-secondary blur-2xl" />
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-8 relative z-10">
        <div className="bg-white border border-brand-text/5 rounded-3xl p-8 md:p-16 text-center shadow-lg relative overflow-hidden group">
          <div className="absolute inset-0 border border-sage-soft/10 rounded-3xl pointer-events-none" />
