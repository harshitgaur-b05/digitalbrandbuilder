  ...
  return (
    <section className="bg-background py-24 md:py-32 relative overflow-hidden transition-colors duration-500" id="cta">
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-8 relative z-10">
        <div className="bg-card border border-border rounded-3xl p-8 md:p-16 text-center shadow-lg dark:shadow-[0_0_30px_rgba(43,158,220,0.05)] relative overflow-hidden group">
          <div className="absolute inset-0 border border-primary/20 rounded-3xl pointer-events-none" />

          <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-8 transition-transform duration-500 group-hover:scale-105">
            <Sparkles className="text-primary w-6 h-6" />
          </div>

          <span className="text-xs font-semibold tracking-[0.2em] text-primary mb-4 uppercase block">
            GET STARTED TODAY
          </span>
