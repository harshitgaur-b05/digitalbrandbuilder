...
})(window,document,'script','dataLayer','GTM-5KZVQ8M3');`}
        </Script>
      </head>
      <body className="min-h-full flex flex-col" suppressHydrationWarning>
        {/* Google Tag Manager (noscript) — must be first element after <body> */}
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-5KZVQ8M3"
            height="0"
            width="0"
